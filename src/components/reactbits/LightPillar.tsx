...
const LightPillar = ({
  ...
  useEffect(() => {
    ...
    if (width === 0 || height === 0) {
      // Container doesn't have dimensions yet, skip initialization
      return;
    }
    ...
    const fragmentShader = `
      ...
      // Apply layered wave deformation to position (simplified)
    ...
    // Animation loop with fixed timestep and visibility detection
    let lastTime = performance.now();
    const targetFPS = 15; // Reduced to 15fps for much better performance
