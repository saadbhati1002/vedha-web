...
const AboutSection: React.FC = () => {
  ...
  return (
    <section className="about pt-200">
      <div className="container">
        <div className="sec-title about-sec-title mb-100">
          ...
          <h2 className="title">
            ...
            scale with comprehensive technology solutions{" "}
            <span>
      ...
      {/* ✅ One single marquee with all 3 images - HIDDEN */}
