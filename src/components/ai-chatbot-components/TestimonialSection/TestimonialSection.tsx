        ...
        >
            ...
            <div className="ac-testimonial-item ul_li xb-border">
              ...
              <div className="xb-item--holder">
                <p className="xb-item--content">
                  "vedha now automates over 70% of our customer queries,
          ...
          <SwiperSlide>
            <div className="ac-testimonial-item ul_li xb-border">
              ...
              <div className="xb-item--holder">
                <p className="xb-item--content">
                  "We launched vedha in just minutes, and the impact was
          ...
          <SwiperSlide>
            <div className="ac-testimonial-item ul_li xb-border">
              ...
              <div className="xb-item--holder">
                <p className="xb-item--content">
                  "vedha's powerful analytics give us deep insights into
