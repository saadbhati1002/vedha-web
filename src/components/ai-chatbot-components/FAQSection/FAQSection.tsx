...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "The setup is instant — once you provide your URL, vedha begins training automatically. Within minutes, your chatbot is ready to answer real customer queries and continuously improve as it learns.",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    answer:
      "Yes! vedha supports 90+ languages, allowing your chatbot to communicate with customers globally in their preferred language.",
  },
  {
    id: 5,
