...
const BlogSection: React.FC = () => {
  ...
  return (
    <section className="blog pt-200 pb-200 bg_img">
                  ...
                  <div className="xb-item--inner img-hove-effect xb-border">
                    ...
                    <div className="xb-item--holder">
                      <ul className="xb-item--meta list-unstyled ul_li">
                        <li>
                          <img src={icon01} alt="icon" /> tech insights
                        </li>
                        <li>
                      ...
                      <h2 className="xb-item--title">
                        <Link to="/blog-details">
                          How Modern Web Development is Transforming Business Operations — Everything You Need to Know
                        </Link>
                      </h2>
                    </div>
                  </div>
                ...
                <div className="xb-blog-item xb-small-blog-item wow fadeInUp" data-wow-delay="150ms" data-wow-duration="600ms">
                  <div className="xb-item--inner img-hove-effect xb-border">
                    ...
                    <div className="xb-item--holder">
                      <ul className="xb-item--meta list-unstyled ul_li">
                        <li>
                          <img src={icon01} alt="icon" /> mobile development
                        </li>
                        <li>
                      ...
                      <h2 className="xb-item--title">
                        <Link to="/blog-details">Mobile App Development: Native vs Cross-Platform — Which is Best for You?</Link>
                      </h2>
                    </div>
                  </div>
                </div>
                ...
                <div className="xb-blog-item xb-small-blog-item wow fadeInUp" data-wow-delay="300ms" data-wow-duration="600ms">
                  <div className="xb-item--inner img-hove-effect xb-border">
                    ...
                    <div className="xb-item--holder">
                      <ul className="xb-item--meta list-unstyled ul_li">
                        <li>
                          <img src={icon01} alt="icon" /> cloud services
                        </li>
                        <li>
                      ...
                      <h2 className="xb-item--title">
                        <Link to="/blog-details">Cloud Migration Strategies: A Complete Guide for Businesses</Link>
                      </h2>
                    </div>
                  </div>
                </div>
